...
| # | Описание |
| ------- | ------- |
| 1 | Внедрить новую систему ServiceDesk  требуется в короткие сроки, поскольку это может повлиять на бизнес.
| 2 | Стоимость внедрения новой системы должна быть приемлимой.
...
| [ADR-4](ADRs/ADR-4.md) | ADR-4: Использовать реплику БД системы для отчётности.
